...
!
! ifort -O2 -axAVX -lnetcdff -L$NETCDF/lib -I$NETCDF/include g_radm_2015.f90 -o radm2015.exe
!
!
...
! ******************************************************************
    ...
    print *,hoy
    write(current_date(4:4),'(A1)')char(5+48) ! para 2015
...
!     Define dimensiones
      ...
      call check( nf90_put_att(ncid, NF90_GLOBAL, "MAP_PROJ_CHAR","Lambert Conformal"))
      call check( nf90_put_att(ncid, NF90_GLOBAL, "MMINLU","USGS"))
      call check( nf90_put_att(ncid, NF90_GLOBAL, "ISWATER",16))
      call check( nf90_put_att(ncid, NF90_GLOBAL, "ISLAKE",-1))
      call check( nf90_put_att(ncid, NF90_GLOBAL, "ISICE",24))
      call check( nf90_put_att(ncid, NF90_GLOBAL, "ISURBAN",1))
      call check( nf90_put_att(ncid, NF90_GLOBAL, "NUM_LAND_CAT",1))
      call check( nf90_put_att(ncid, NF90_GLOBAL, "ISOILWATER",1))
