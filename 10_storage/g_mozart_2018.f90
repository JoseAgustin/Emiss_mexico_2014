...
!
! ifort -O2 -axAVX -lnetcdff -L$NETCDF/lib -I$NETCDF/include g_mozart_2018.f90 -o mozart.exe
!
!
...
! ******************************************************************
    ...
    print *,hoy
    write(current_date(4:4),'(A1)')'8' ! PARA EL ANIO 2018 
     do periodo=1,2 !2 or 1
